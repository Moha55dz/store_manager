...
urlpatterns = [
    ...
    path('purchased-phone/delete/<int:pk>/', views.delete_purchased_phone, name='delete_purchased_phone'),
    ...
    path('electronic-service/delete/<int:pk>/', views.delete_electronic_service, name='delete_electronic_service'),
    ...
    path('installment/delete/<int:pk>/', views.delete_installment, name='delete_installment'),
    ...
    path('delivery-tracker/delete/<int:pk>/', views.delete_delivery_tracker, name='delete_delivery_tracker'),
